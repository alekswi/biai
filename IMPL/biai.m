...
Train = imageDatastore("..\DATA\train\", 'LabelSource', 'foldernames', 'IncludeSubfolders',true);
Validation = imageDatastore("..\DATA\validation\", 'LabelSource', 'foldernames', 'IncludeSubfolders',true);
Test = imageDatastore("..\DATA\test\", 'LabelSource', 'foldernames', 'IncludeSubfolders',true);
inputSize = [224 224];
